...
@Getter
public class SummaryCreateClovaRequest {
    private static final String SYSTEM_CONTENT = ResourceLoader.getResourceContent("summary-generate-prompt.txt");
    ...
    public SummaryCreateClovaRequest(List<Map<String, String>> messages) {
        this.messages = messages;
    }

    public static SummaryCreateClovaRequest createSummaryClovaRequest(List<Paragraph> paragraphs) {
        ...
        return new SummaryCreateClovaRequest(messages);
    }
}
